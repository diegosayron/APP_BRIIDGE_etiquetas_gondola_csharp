using ZXing;
using ZXing.Common;using APP_BRIIDGE_etiquetas.Models;
...
public class Etiqueta100x37Printer : EtiquetaPrinterBase
{
    public Etiqueta100x37Printer(Produto produto)
        : base(produto)
    {
    }
